...
//             'lib/elasticlunr/lunr-languages/tinyseg.js', 
             'lib/elasticlunr/tinyseg.js',
             'lib/elasticlunr/wordcut.js',
             'lib/elasticlunr/lunr-languages/min/lunr.stemmer.support.min.js', 
             'lib/elasticlunr/lunr-languages/lunr.multi.js', 
//             'lib/elasticlunr/lunr-languages/min/lunr.multi.min.js', 
//             'lib/elasticlunr/lunr-languages/lunr.jp.js'
//             'lib/elasticlunr/lunr.ja.js'
             'lib/elasticlunr/lunr-languages/lunr.ja.js'
            ], function(elasticlunr, tinyseg, wordcut, stemmerSupport, multi, ja) {
        stemmerSupport(lunr);
        tinyseg(lunr);
        ja(lunr);
        multi(lunr);
